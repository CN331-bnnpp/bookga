...
class group(models.Model):
    ...
    """
    username = models.ForeignKey(User, on_delete=models.CASCADE, limit_choices_to={"is_staff": True})
...
class group_member(models.Model):
    ...
    """
    username = models.ForeignKey(User, on_delete=models.CASCADE, limit_choices_to={"is_staff": False})
